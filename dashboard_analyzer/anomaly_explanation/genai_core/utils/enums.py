...
# - AnomalyInterpreterAgent (tree interpretation): Sonnet 4.5 (temporarily; Opus 4.6 pending prod ARN)
# - AnomalySummaryAgent (executive summarizer): Sonnet 4.5 (temporarily; Opus 4.6 pending prod ARN)
CAUSAL_LLM_TYPE = "CLAUDE_SONNET_4_5"
INTERPRETER_LLM_TYPE = "CLAUDE_SONNET_4_5"  # TODO: restore to CLAUDE_OPUS_4_6 once prod inference profile ARN is configured
SUMMARIZER_LLM_TYPE = "CLAUDE_SONNET_4_5"  # TODO: restore to CLAUDE_OPUS_4_6 once prod inference profile ARN is configured
